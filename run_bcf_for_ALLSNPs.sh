...
bcftools mpileup -q 30 --regions-file ALL_SNPs.bed -f dmel-all-chromosome-r6.41.fasta align/304_SR.bam | bcftools call -c -o /data/julie/FemaleRT/304_SR_ALL.vcf 

bcftools mpileup -q 30 --regions-file ALL_SNPs.bed -f dmel-all-chromosome-r6.41.fasta align/304_ST.bam  | bcftools call -c -o /data/julie/FemaleRT/304_ST_ALL.vcf 

bcftools mpileup -q 30 --regions-file ALL_SNPs.bed -f dmel-all-chromosome-r6.41.fasta align/304_PV.bam  | bcftools call -c -o /data/julie/FemaleRT/304_PV_ALL.vcf 

bcftools mpileup -q 30 --regions-file ALL_SNPs.bed -f dmel-all-chromosome-r6.41.fasta align/307_SR.bam | bcftools call -c -o /data/julie/FemaleRT/307_SR_ALL.vcf 
